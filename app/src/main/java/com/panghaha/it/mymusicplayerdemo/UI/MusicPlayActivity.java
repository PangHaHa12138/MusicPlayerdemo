...
//        mMusicDatas.add(musicData3);
        ...
        mMusicDatas.add(new MusicData(R.raw.m2, R.drawable.mmpp, "没有双截棍，依然一身正气", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m3, R.drawable.pan2, "中药的秘方是怎么来的", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m4, R.drawable.mmpp, "学生跟老罗较劲的怪问题", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m11, R.drawable.pan1, "老罗被问到什么是牛奶路", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m14, R.drawable.pan2, "老罗为何做火车扔鞋", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m18, R.drawable.mmpp, "老外用含笑九泉表示自己开心", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m21, R.drawable.pan2, "禁止携带西红柿和鸡蛋", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m26, R.drawable.mmpp, "听说黎明要来了，北京的小姑娘从8岁等到18岁", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m28, R.drawable.pan2, "新东方靠的什么", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m29, R.drawable.pan1, "一夫多妻制", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m31, R.drawable.mmpp, "哥哥为何不同意父亲买沙袋", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m35, R.drawable.pan2, "学生被老罗说的抱头鼠窜", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m39, R.drawable.mmpp, "手语不是全球通用的", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m40, R.drawable.pan2, "不同种族对募捐的态度", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m45, R.drawable.mmpp, "愤世嫉俗不等于犬儒主义者", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m46, R.drawable.pan1, "小鸟是怎么认识妈妈的", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m49, R.drawable.pan2, "法律健全也会被敲诈", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m52, R.drawable.mmpp, "如何对待叛逆少年，老罗给你支招", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m55, R.drawable.pan2, "这次考试和以往有什么差别", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m58, R.drawable.mmpp, "如果你有罪上帝会勒死你", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m59, R.drawable.pan2, "淋着雨唱这歌我们都是害虫", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m60, R.drawable.mmpp, "蛇，乌龟都遭了殃", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m61, R.drawable.pan2, "老罗曾经是新东方一哥", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m64, R.drawable.mmpp, "过年看电视春晚的无奈", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m65, R.drawable.pan2, "倚天屠龙记", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m70, R.drawable.mmpp, "幸运的意外", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m71, R.drawable.pan2, "老罗被学生举报上课讲黄色的东西", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m72, R.drawable.pan1, "婴儿的反应", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m74, R.drawable.mmpp, "一咬牙，沦为教师", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m78, R.drawable.pan1, "猫为何爱抓毛线团", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m79, R.drawable.pan2, "谁都可以是大师", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m80, R.drawable.mmpp, "学生跟老罗较劲的怪问题", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m82, R.drawable.pan2, "笔记本风扇打雷", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m83, R.drawable.pan2, "我也是一个普通人嘛", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m84, R.drawable.mmpp, "罗永浩语录", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m86, R.drawable.pan2, "高山族是怎么来的", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m87, R.drawable.pan1, "这小子不是恶心我吧", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m91, R.drawable.mmpp, "仁者见仁，淫者见淫", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m92, R.drawable.pan2, "故意让你做错的题", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m94, R.drawable.pan1, "令人愉悦的忧伤", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m97, R.drawable.mmpp, "罗永浩语录", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m99, R.drawable.pan2, "骗子中药", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m100, R.drawable.pan2, "彪悍的人生不需要解释", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m105, R.drawable.pan2, "印刷的错误", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m106, R.drawable.mmpp, "老罗不换衣服", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m107, R.drawable.pan2, "好多词都变味了", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m111, R.drawable.pan2, "再好好想想，感情还没破裂吗", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m112, R.drawable.mmpp, "曾经想拯救华语电影", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m116, R.drawable.pan2, "男人都一个德行", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m117, R.drawable.mmpp, "娇滴滴的民族情绪", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m120, R.drawable.pan2, "老罗减肥", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m123, R.drawable.pan1, "冒险与疯狂", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m125, R.drawable.pan2, "刘欢给女儿起名字", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m129, R.drawable.pan1, "罗永浩语录", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m130, R.drawable.mmpp, "罗永浩语录", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m135, R.drawable.pan2, "罗永浩语录", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m137, R.drawable.pan1, "罗永浩语录", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m143, R.drawable.mmpp, "真的猛男", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m146, R.drawable.pan1, "每一本被焚毁的书都照亮了这个世界", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m147, R.drawable.mmpp, "母语", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m149, R.drawable.pan2, "真假金庸", "罗永浩"));
        mMusicDatas.add(new MusicData(R.raw.m153, R.drawable.mmpp, "罗永浩语录", "罗永浩"));
...
//        mMusicDatas.add(new MusicData(R.raw.m7, R.drawable.yutong1, "西游记之女儿国奇遇记", "全体百思女神"));
//        mMusicDatas.add(new MusicData(R.raw.m8, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
...
//        mMusicDatas.add(new MusicData(R.raw.m12, R.drawable.yutong1, "【开心一刻】你家里缺宠物么，就是读过大学会说中国话的那种", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m13, R.drawable.yutong1, "【开心一刻】教你一秒制服冷战中的老婆", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m15, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m17, R.drawable.yutong1, "【开心一刻】人生四大经典骗局，你至少上过一次当", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m16, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m19, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m20, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m22, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
...
//        mMusicDatas.add(new MusicData(R.raw.m25, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
...
//        mMusicDatas.add(new MusicData(R.raw.m33, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
...
//        mMusicDatas.add(new MusicData(R.raw.m37, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m38, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
...
//        mMusicDatas.add(new MusicData(R.raw.m43, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m44, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
...
//        mMusicDatas.add(new MusicData(R.raw.m50, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
...
//        mMusicDatas.add(new MusicData(R.raw.m54, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m56, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m57, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m62, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m63, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
...
//        mMusicDatas.add(new MusicData(R.raw.m68, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
...
//        mMusicDatas.add(new MusicData(R.raw.m75, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
...
//        mMusicDatas.add(new MusicData(R.raw.m85, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
...
//        mMusicDatas.add(new MusicData(R.raw.m93, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
...
//        mMusicDatas.add(new MusicData(R.raw.m98, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m101, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m103, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m104, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m108, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m109, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m110, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m113, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m114, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m115, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m118, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
...
//        mMusicDatas.add(new MusicData(R.raw.m124, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
...
//        mMusicDatas.add(new MusicData(R.raw.m128, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m131, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m132, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
...
//        mMusicDatas.add(new MusicData(R.raw.m136, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
...
//        mMusicDatas.add(new MusicData(R.raw.m140, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
...
//        mMusicDatas.add(new MusicData(R.raw.m145, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
...
//        mMusicDatas.add(new MusicData(R.raw.m151, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m152, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m154, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m155, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
//        mMusicDatas.add(new MusicData(R.raw.m156, R.drawable.yutong1, "【开心一刻】", "NJ语瞳"));
