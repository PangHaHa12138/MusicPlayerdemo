 ...
 */
public class MusicPlayActivity3 extends AppCompatActivity implements IPlayInfo,View.OnClickListener{
...
//        mMusicDatas.add(musicData3);
        ...
        mMusicDatas.add(new MusicData(R.raw.mp1, R.drawable.mmpp, "Justice Skolnik,Lost Kings,Tinashé", "Quit You(Justice Skolnik Remix)"));
        mMusicDatas.add(new MusicData(R.raw.mp2, R.drawable.mmpp, "Relient K", "PTL"));
        mMusicDatas.add(new MusicData(R.raw.mp3, R.drawable.pan2, "FOOL (傻瓜 KR Ver.)", "WINNER"));
        mMusicDatas.add(new MusicData(R.raw.mp4, R.drawable.mmpp, "不找了", "郭旭"));
        mMusicDatas.add(new MusicData(R.raw.mp5, R.drawable.pan2, "우주를 줄게 (给你宇宙)", "脸红的思春期"));
        mMusicDatas.add(new MusicData(R.raw.mp6, R.drawable.mmpp, "세 단어 （THREE WORDS）", "水晶男孩"));
        mMusicDatas.add(new MusicData(R.raw.mp7, R.drawable.mmpp, "비밀이야 (Secret 秘密)", "宇宙少女"));
...
//        musicService2.stop();
    ...
    private Drawable getForegroundDrawable(int musicPicRes) {
        ...
        final float widthHeightSize = (float) (DisplayUtil.getScreenWidth(MusicPlayActivity3.this)
