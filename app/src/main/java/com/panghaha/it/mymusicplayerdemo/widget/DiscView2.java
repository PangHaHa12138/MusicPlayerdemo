...
public class DiscView2 extends RelativeLayout {
    ...
    public DiscView2(Context context) {
        this(context, null);
    }

    public DiscView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DiscView2(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                if (mIsNeed2StartPlayAnimator) {
                    ...
                    if (!mViewPagerIsOffset) {
                        /*延时500ms*/
                        DiscView2.this.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                playAnimator();
                            }
    ...
    public void setMusicDataList(List<MusicData2> musicDataList) {
        ...
        int i = 0;
        for (MusicData2 musicData : mMusicDatas) {
        ...
        MusicData2 musicData = mMusicDatas.get(0);
        if (mIPlayInfo != null) {
    ...
    public void notifyMusicInfoChanged(int position) {
        if (mIPlayInfo != null) {
            MusicData2 musicData = mMusicDatas.get(position);
            mIPlayInfo.onMusicInfoChanged(musicData.getMusicName(), musicData.getMusicAuthor());
        }
    }
